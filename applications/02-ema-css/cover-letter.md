# Cover Letter — Ema, Customer Success Specialist (US)
...
The "Universal AI Employee" thesis is one I've been building toward for two years. I'm writing because I think I can help your customers actually deploy and adopt Ema in production — not because I'm a CSM looking for an AI company, but because I'm an AI builder who happens to be exceptional at customer outcomes.
...
At Harvest Investment Strategies I currently design AI brand systems for a wealth management firm. The prompt framework is **3 prompts, not 30** — because complexity is the enemy of adoption, especially with non-technical teams. I expect Ema's most valuable customers are the ones whose teams aren't AI-native. I know how to bridge that gap.

**Why Ema specifically:**

1. **You're solving the right problem.** Universal AI Employee is the right architectural bet — fragmenting agents per task is a dead end.
2. **Your customers need a CSM who speaks the stack.** I do. Peer fluency, not buzzwords.
3. **Remote-first is how I already work.** Pulte, Harvest, writenode — all remote.

I'd love to talk about how Ema thinks about CS in the AI agent era, and where I could plug in immediately.
