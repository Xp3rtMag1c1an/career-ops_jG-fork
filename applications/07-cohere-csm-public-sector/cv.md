...
**Customer Success · Applied AI Builder · Operator**

Scottsdale, AZ (Remote, US Citizen) · jcg23@icloud.com · 303.503.4595
...
## Why Cohere — US Public Sector

- **US Citizen, no sponsorship needed** — eligible for Public Sector roles
- **Regulated industry experience** — four years at Pulte in federally regulated mortgage lending = comfortable with compliance, audit, and high-trust customer environments
- **Peer fluency in LLM stack** — writenode integrates LLMs in production
- **Mission alignment** — Cohere's enterprise/government focus on responsible AI is the right wedge
...
- Comfortable working with LLM APIs, embeddings, prompt engineering, retrieval, and agent orchestration
...
- Designed AI brand systems for wealth management firm
- Built prompt engineering framework — **3 prompts, not 30** — because complexity kills adoption
...
- Operated across cultural and organizational lines in international development context
...
**LLM/AI:** Embeddings · Vector retrieval · Prompt engineering · MCP · LLM orchestration · RAG patterns
**Regulatory/Compliance:** CFPB · RESPA · TRID · Federally regulated environments
**Customer Success:** Onboarding · Adoption · Retention · Training & enablement · Strategic advisory
**Operations:** Pipeline management at scale · Cross-functional execution

## Citizenship & Clearance

**US Citizen** — Eligible for Public Sector roles. No sponsorship needed.
